...
class FactoryBase {
  ...
  static _getFulfillmentJsonLD () {
    if (!this.fulfillmentEntities) {
      this.fulfillmentEntities = JSON.parse(request('GET', `https://raw.githubusercontent.com/NYPL/nypl-core/${coreVersion}/vocabularies/json-ld/fulfillmentEntities.json`).getBody())
    }
  ...
  static _getPatronTypeJsonLD () {
    ...
    console.log(`https://raw.githubusercontent.com/NYPL/nypl-core/${coreVersion}/vocabularies/json-ld/patronTypes.json`)
